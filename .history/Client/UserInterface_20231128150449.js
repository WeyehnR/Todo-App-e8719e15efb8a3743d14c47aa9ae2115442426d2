export default class UI {
     ...
     * <ul class="Tags-menu-selection">
        ...
        randomly generated.
     */
    generateRandomColor(listName) { return

    addNewTag() {
        const newTag = document.createElement('li');
        newTag.className = 'menu-item tag';
        newTag.innerHTML = `Tag ${this.tags.length + 1}`;
        newTag.style.backgroundColor = this.generateRandomColor();
        this.tags.push(newTag);
        this.querySelector('.Tags-menu-selection').appendChild(newTag);
    }
