export default class UI {
    ...
    loadSubtasks(taskId) {
        ...
        subtaskList.innerHTML = ''; // Clear the existing subtasks
    ...
    addSubtaskEventListener(taskId) {
        this.getElementById('add-subtask-btn').addEventListener('click', () => {
            ...
            if (subtaskInput.value) {
                ...
                this.loadSubtasks(taskId); // Load the subtasks after adding a new one
            }
        });
    }
    ...
    init() {
        document.addEventListener("DOMContentLoaded", () => {
            ...
            this.loadSubtasks(this.getCurrentTaskId()); // Load the subtasks when the page is loaded
        });
    }
