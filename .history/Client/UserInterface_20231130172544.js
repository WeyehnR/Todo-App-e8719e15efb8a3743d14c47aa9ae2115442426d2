    ...
    addNewTag() {
        return new Promise((resolve, reject) => {
            ...
            if (!addTagButton || !tagDropdown) {
                throw new Error('Add tag button or dropdown not found');
            } else {
            ...
            renameTag(oldTagText, newTagText) {
                ...
                if (!renameTagBtn) {
                    throw new Error('Rename tag button not found');
                } else {
            ...
            createTagElement(text, bgColor) {
                ...
                if (!newTag) {
                    throw new Error('Unable to create tag element');
                } else {
            ...
            displayNewListForm() {
                const newListForm = this.getElementById('new-list-form');
                if (!newListForm) {
                    throw new Error('New list form not found');
                } else {
