...
export default class UI {
    ...
    expandRightMenu(event) {
        ...
        // Update the _selectedList property of the active task to the first option in the dropdown menu
        const firstOption = listDropdownMenu.options[0];
        const activeTaskObject = this.taskManager.getTaskById(this.activeTaskId);
        activeTaskObject._selectedList = firstOption ? firstOption.value : '';
    }
