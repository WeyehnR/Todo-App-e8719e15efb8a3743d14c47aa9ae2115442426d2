...
export default class ListManager {
    constructor(ui) {
        ...
        this.ui = ui;
        this.taskDetails = new TaskDetailsUI();
            ...
            if (event.key === 'Enter') {
                ...
                if (newListName) {
                    ...
                    if (lists.length === 1) {
                     ...
                     // Show the tags-menu collection
                    const tagsMenu = document.querySelector('.Tags-menu-selection');
    ...
    async loadLists() {
        ...
        // If the list is empty, load task details from the server
        if (lists.length === 0) {
            await this.taskDetails.loadTaskDetailsFromServer();
        }
    }
