...
export default class TaskDetailsUI {
    constructor(taskManager, ui) {
        ...
        // <img src="../icons/Icon close.svg" alt="Close" class="close-icon"></img>
    ...
    initEventListeners() {
        ...
        newButton.addEventListener('click', async () => {
            ...
            if (subtaskName) {
                ...
                const taskId = Number(localStorage.getItem('activeTaskId'));
                try {
    ...
    async updateTaskWithSubtask(taskId, subtask) {
        ...
        console.log(`Updating task with ID: ${taskId}`); // Add this line
