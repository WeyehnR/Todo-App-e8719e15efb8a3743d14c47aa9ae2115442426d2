    ...
    addTaskEventListener() {
        ...
        if (addTaskBtn && !this.addTaskButtonClicked) {
            addTaskBtn.addEventListener('click', () => {
                ...
                const selectedList = listSelect.options[listSelect.selectedIndex].value ? [listSelect.options[listSelect.selectedIndex].value] : ['Select List'];

                const dueDateSelect = this.domHelper.getElementById('due-date-select');
                const selectedDueDate = dueDateSelect.options[dueDateSelect.selectedIndex].value ? [dueDateSelect.options[dueDateSelect.selectedIndex].value] : ['Select Due Date'];

                const tagsSelect = this.domHelper.getElementById('tags-select');
                const selectedTags = tagsSelect.options[tagsSelect.selectedIndex].value ? [tagsSelect.options[tagsSelect.selectedIndex].value] : ['Select Tags'];
