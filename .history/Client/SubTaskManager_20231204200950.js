...
export default class SubTaskManager{
    ...
    renderSubtasks() {
        const subtaskList = this.domHelper.getElementById('subtask-list');
        subtaskList.innerHTML = '';
        //check the subtask list
        console.log('subtask list:', this.task._subtasks);
        //and its inner html for subtaks-list
        console.log('subtask list inner html:', subtaskList.innerHTML);
        this.task._subtasks.forEach((subtask) => {
            const subtaskElement = this.createSubtaskElement(subtask);
            subtaskList.appendChild(subtaskElement);
            console.log('subtasks rendered!')
        });
    }
