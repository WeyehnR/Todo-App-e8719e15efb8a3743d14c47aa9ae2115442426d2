...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Get a reference to the right arrow button and the right menu card
    const rightArrowButton = document.querySelectorAll(".arrow-btn");
    const rightMenuCard = document.getElementById("right-menu-card");

    // Add a click event listener to toggle the right menu card's expanded state
