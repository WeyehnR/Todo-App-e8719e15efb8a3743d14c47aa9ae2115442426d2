...
class TaskManager {
    ...
    saveTaskToLocalStorage(task) {
        if (typeof localStorage !== 'undefined') {
            ...
            task.taskRenameInput = task.name;  // Set the taskRenameInput to the name of the task
    ...
    loadTasksFromLocalStorage() {
        ...
        if (typeof localStorage !== 'undefined') {
            ...
            tasksData.forEach(taskData => {
                ...
                task.taskRenameInput = taskData.taskRenameInput;  // Set the taskRenameInput to the taskRenameInput of the task data
                tasks.push(task);
            });
        }
        ...
        if (taskRenameInput && tasks.length > 0) {
            taskRenameInput.value = tasks[0].taskRenameInput || tasks[0]._name;
        }
