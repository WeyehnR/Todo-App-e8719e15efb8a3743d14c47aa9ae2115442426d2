        ...
        if (typeof localStorage !== 'undefined') {
            ...
            for (let i = 0; i < localStorage.length; i++) {
                ...
                if (key.startsWith('task-')) {
                    ...
                    // Check if description, list, and dueDate are not empty strings
                    if (!taskData.description || !taskData.list || !taskData.dueDate) {
                        console.error('Task description, list, or dueDate is empty');
                        continue;
                    }
