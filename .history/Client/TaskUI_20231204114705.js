    ...
    addTaskEventListener() {
        ...
        if (addTaskBtn && !this.addTaskButtonClicked) {
            addTaskBtn.addEventListener('click', () => {
                ...
                const selectedList = listSelect.value ? [listSelect.value] : ['Select List'];

                const dueDateSelect = this.domHelper.getElementById('due-date-select');
                const selectedDueDate = dueDateSelect.value ? [dueDateSelect.value] : ['Select Due Date'];

                const tagsSelect = this.domHelper.getElementById('tags-select');
                const selectedTags = tagsSelect.value ? [tagsSelect.value] : ['Select Tags'];
