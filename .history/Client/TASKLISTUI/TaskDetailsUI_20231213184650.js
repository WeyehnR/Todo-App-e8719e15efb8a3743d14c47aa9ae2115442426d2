            ...
            this.dueDateSelect.addEventListener('change', (event) => {
                ...
                if (updatedTask) {
                    ...
                    if (activeTask) {
                        ...
                        // Insert the due date element after the arrow button
                        const arrowButton = activeTask.querySelector('.arrow-btn');
                        arrowButton.parentNode.insertBefore(dueDateElement, arrowButton.nextSibling);
                    }
                } else {
                    console.error(`Task with id ${activeTaskId} not found`);
                }
