    ...
    renameTag() {
        ...
        tagTexts.forEach(tagText => {
            tagText.addEventListener('click', () => {
                ...
                // Add an event listener to the blur event of the input field
                input.addEventListener('blur', updateTagName);

                // Add an event listener to the keydown event of the input field
                ...
                function updateTagName() {
                    // Get the new tag name from the input field
                    const newTagName = input.value;

                    // Replace the input field with the new tag name
                    tagText.textContent = newTagName;

                    // Update the tag in local storage
                    let tags = JSON.parse(localStorage.getItem('tags')) || [];
