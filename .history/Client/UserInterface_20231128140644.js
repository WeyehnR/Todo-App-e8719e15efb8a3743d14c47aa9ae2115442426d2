export default class UI {
        ...
        this.getElementById('new-list-name').addEventListener('keypress', (event) => {
            if (event.key === 'Enter') {
                ...
                if (newListName) {
                    ...
                    newListElement.className = 'menu-item';
                    newListElement.innerHTML = `<span class="icon" style="background-color: ${dynamicColor};"></span>${newListName}<span class="item-count"></span>`;
                    this.querySelector('.Lists-menu-selection').appendChild(newListElement);
                    event.target.value = '';
    ...
    init() {
        document.addEventListener("DOMContentLoaded", () => {
            ...
            this.addNewListNameEventListener(); this
        });
    }
