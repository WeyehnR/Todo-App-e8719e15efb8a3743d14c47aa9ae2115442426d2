...
export default class UI {
    ...
    bindUIEventListeners() {
        ...
        // Check if an event listener has already been attached
        if (!todoList.getAttribute('data-listener')) {
            // Add a click event listener
            const listener = (event) => this.expandRightMenu(event);
            todoList.addEventListener('click', listener);

            // Store the listener in a data attribute
            todoList.setAttribute('data-listener', 'true');
        }
