...
export default class TaskDetailsUI {
    ...
    updateTaskProperty(property, value) {
        ...
        const selectedTask = document.querySelector(`li[data-task="${taskId}"]`);

        // Create a new element for the due date
        const dueDateElement = document.createElement('div');
        dueDateElement.textContent = task.selectedDueDate;

        // Append the due date element to the selected task
        selectedTask.appendChild(dueDateElement);
    }
