...
export default class TaskListUI {
    ...
    handleArrowButtonClick(event, task) {
        ...
        this.rightMenuCard.style.display = 'block'; // Add this line
        this.todoContainer.classList.add('right-expanded');

        // Set the id of the right menu card to "right-menu-card-{task.id}"
        this.rightMenuCard.id = `right-menu-card-${task.id}`;
        ...
        this.updateTaskFields(activeTask.name);
    }
