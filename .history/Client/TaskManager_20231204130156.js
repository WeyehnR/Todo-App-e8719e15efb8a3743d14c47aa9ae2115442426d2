...
class TaskManager {
    ...
    handleInput = () => {
        ...
        if (selectedTaskId) {
            ...
            if (selectedTask) {
                selectedTask.renameValue = taskRenameInput.value; // update the renameValue of the selected task
                this.saveTaskToLocalStorage(selectedTask); // save the updated task to local storage
            }
        }
    }
