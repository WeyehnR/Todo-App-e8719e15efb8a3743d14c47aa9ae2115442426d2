...
class TaskManager {
    ...
    // In your handleInput method, store the taskRenameInput value in the renameValue property of the selected task
    handleInput = () => {
        const taskRenameInput = document.querySelector('.task-rename');
        ...
        if (selectedTaskId) {
            ...
            if (selectedTask) {
                selectedTask.renameValue = taskRenameInput.value; // store the taskRenameInput value in the renameValue property of the selected task
                this.saveTaskToLocalStorage(selectedTask); // save the selected task to local storage
            }
        }
    }
