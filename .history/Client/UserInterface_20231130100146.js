export default class UI {
    ...
    addNewTag() {
        this.querySelector('.add-tag').addEventListener('click', () => {
            ...
            newTag.innerHTML = `${tagText} <button class="delete-tag" style="background-color: ${bgColor};">x</button>`;
            ...
            newTag.addEventListener('click', () => {
                ...
                input.addEventListener('blur', () => {
                    newTag.innerHTML = `${input.value} <button class="delete-tag" style="background-color: ${bgColor};">x</button>`;
                });
