export default class UI {
    ...
    addNewList() {
            ...
            if (!newListNameElement) {
                console.log('New list name element not found');
            } else {
    ...
    createListElement(name, color) {
            ...
            if (!newListElement) {
                console.log('Unable to create list element');
            } else {
    ...
    addNewTag() {
            ...
            if (!addTagButton || !tagDropdown) {
                console.log('Add tag button or dropdown not found');
            } else {
    ...
    deleteTag(tagText) {
            ...
            if (!deleteTagBtn) {
                console.log('Delete tag button not found');
            } else {
    ...
    renameTag(oldTagText, newTagText) {
            ...
            if (!renameTagBtn) {
                console.log('Rename tag button not found');
            } else {
    ...
    loadTags() {
        ...
        if (!tags) {
            ...
            tags.forEach(tag => {
                ...
                const addTagButton = this.querySelector('.add-tag');
                if (!addTagButton) {
                    console.error('Add tag button not found');
                } else {
                    addTagButton.parentNode.insertBefore(newTag, addTagButton);
                }
            });
    ...
    createTagElement(text, bgColor) {
            ...
            if (!newTag) {
                console.log('Unable to create tag element');
            } else {
    ...
    displayNewListForm() {
            ...
            const newListForm = this.getElementById('new-list-form');
            if (!newListForm) {
                console.log('New list form not found');
            } else {
