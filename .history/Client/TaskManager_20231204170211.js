...
class TaskManager {
    ...
    handleInput = () => {
        ...
        console.log('taskRenameInput', taskRenameInput);
        if (taskRenameInput && taskRenameInput.value) {
            this.saveInputValueToLocalStorage('.task-rename', 'taskRenameInput');
            console.log('taskRenameInput.value', taskRenameInput.value);
            console.log('task-rename input value saved to localStorage');
        }
    }
    ...
    saveInputValueToLocalStorage(selector, key) {
        if (key) {
            ...
            if (inputElement) {
                ...
                // console.log(`Saved ${key} to localStorage and its value is ${inputValue}`);
            }
        }
    }
